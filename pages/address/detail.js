...
Page({
  ...
  getAddressLabel: function () {
    ...
    App._get('address/getAddressLabel', {
...
// 选择标签栏
  chooseLabelType:function(e){
// console.log(e.target.dataset.type);
this.setData({
  labelId: e.target.dataset.type
})
  },
// 是否设为默认
  chooseDefault:function(){

    // console.log(this.data.chooseDef);
    this.setData({
      chooseDef: !this.data.chooseDef
    })
  },
